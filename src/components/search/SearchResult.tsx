...
import {
  ...
  interactiveSelectedSoftTextClassName,
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isHighlighted
          ? cn(interactiveSelectedClassName, "shadow-[0_24px_80px_rgba(15,23,42,0.18)]")
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-3">
            ...
            <Badge
              ...
              className={cn(
                ...
                isHighlighted
                  ? cn(interactiveSelectedSoftSurfaceClassName, interactiveSelectedSoftTextClassName)
                  : feature.implemented
          ...
          <p
            className={cn(
              ...
              isHighlighted ? interactiveSelectedMutedTextClassName : "text-muted-foreground"
            )}
          >
            {feature.description}
          </p>
